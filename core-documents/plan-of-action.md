...
**Core strategic constraint:** The long-arc goal — a constitutional amendment establishing an independent epistemic oversight body — is a generational project. Near-term work is about building legitimacy, demonstrating proof of concept, and attracting the people and resources needed to make the bigger project credible. Every early decision should be evaluated against that standard.

**Defining commitment:** Aggressively nonpartisan. This means applying the framework symmetrically and visibly, including when it's uncomfortable. The credibility of the entire project depends on this being demonstrably true, not just claimed.

---

## Phase 1: Foundation (Months 1–3)

*Goal: Build the intellectual and organizational infrastructure before going public. Nothing public-facing yet. Get the foundation right.*
...
You will eventually need a legal entity. The right structure is almost certainly a 501(c)(3) nonprofit for the research and public education function, potentially with a 501(c)(4) arm later for advocacy. But incorporating costs money and creates administrative overhead.

**Recommendation for Phase 1:** Do not incorporate yet. Operate as an unincorporated project. Focus on building intellectual credibility and finding initial allies. Incorporate once you have at least one other committed co-founder and a clearer picture of funding.
...
- **Former politicians or senior government officials** — bipartisan, retired, with the credibility that comes from having served
- **Epistemologists or philosophers of science** — to defend the "empirically falsifiable" standard
...
Suggested early pieces:
- "Why professional accountability for politicians isn't a First Amendment problem" — the core legal argument in accessible form
- "What would an epistemically independent institution actually look like?" — walks through the oversight architecture
...
- Define the category of statements that qualify (and explicitly exclude opinion, policy judgment, contested science)
- Specify the evidentiary standard (peer-reviewed evidence, government data, documented record)
- Describe the appeals process
- Give worked examples, including examples of statements that look like violations but don't qualify

This document is a technical and philosophical achievement that will attract serious people to the project.
...
- A public database of documented false official statements by covered officials
- Bipartisan — equal rigor applied to politicians of both parties
- Methodologically transparent — every entry links to its evidentiary basis
- Searchable and shareable

This is the proof of concept. It answers the question "how would this actually work?" It also generates media coverage, demonstrates institutional seriousness, and creates a feedback loop: when the tracker catches a false statement by a politician, their opponents have an incentive to share it; when it catches statements on both sides, serious people notice the discipline.

Build this as a simple, well-designed web application. Stack recommendation: Next.js or similar, hosted on Vercel (free tier), database on PlanetScale or Supabase (free tier). Total cost: $0–$15/month.

### 3.2 Establish Editorial Standards for the Tracker

Before populating the tracker, publish its editorial standards — the full methodology from Phase 2.4 — and ideally have it reviewed by at least one credible external party (an academic, a journalist, a lawyer) who can be named. This gives critics something specific to engage with rather than a vague claim of objectivity.

### 3.3 Formal Launch

By this point you should have:
- White paper, public explainer, one-pager
- A founding advisory council with at least 5–7 members spanning partisan lines
- A live accountability tracker with initial entries
- A body of public writing
- A basic organizational structure (incorporated or fiscally sponsored)

The launch should be an event, not just a website going live. Possible formats:
- A published op-ed in a national outlet, co-signed by advisory council members
- A launch event (virtual is fine) featuring advisors discussing the proposal
- A press release to political reporters, legal journalists, and democracy reform beat writers

The goal of the launch is not mass public attention — it is attention from the 500–1,000 people in the country who work on democracy reform, constitutional law, and press accountability. If those people take it seriously, the broader audience follows.

---

## Phase 4: Institutionalization and Growth (Month 18+)

*Goal: Transition from movement-building to institution-building. This is when the founder steps back into a governance role rather than an operational one.*
...
### 4.2 Hire an Executive Director

The founder's role is to conceive, build, and launch — then find someone better suited to run it. The right executive director for this project has experience running nonpartisan policy organizations, relationships across the political spectrum, and the personal credibility to be taken seriously in Washington and in academia. That person is not usually a first-time founder, which is why recruiting them is a Phase 4 task, not a Phase 1 task.

### 4.3 Legal and Legislative Strategy

By this phase, the white paper should have been refined through public engagement. Begin developing relationships with sympathetic members of Congress from both parties. The near-term legislative targets are not the constitutional amendment — that's the endgame — but the more modest statutory proposals: FCC licensing conditions, public broadcaster standards, enhanced disclosure requirements. These are achievable through ordinary legislation and create precedent and momentum for the larger structural reforms.

### 4.4 Build the Coalition Explicitly
...
**The partisan capture risk.** The project will be accused of being a partisan weapon regardless of how carefully it's designed. The only defense is behavioral — relentless symmetry in application, and a founding coalition that makes the accusation implausible. Every significant early decision should be evaluated against the question: "Does this make the partisan capture accusation easier or harder to make?"

**The founder bandwidth risk.** You will get a job. Time will compress. This is a known constraint, not a surprise. Design the project so that the most important early work — the white paper, the methodology document, the initial coalition outreach — happens before the job does. Once employed, the project needs to be sustainable on 10–15 hours per week or it needs a co-founder who can carry more.

**The "too ambitious" risk.** The constitutional amendment endgame is genuinely very ambitious. Leading with it publicly will cause some people to dismiss the project as utopian. The near-term framing should lead with the achievable statutory reforms — FCC conditions, disclosure requirements, enhanced ethics regimes — and position the amendment as the long-arc vision, not the immediate ask.

**The "who decides what's false" attack.** This is the most powerful objection the project will face, and it needs a better answer than "a nonpartisan body." The answer lives in the methodology: the project covers only claims where the evidentiary record is unambiguous, applies peer-review standards, requires appeals, and publishes its reasoning transparently. The accountability tracker is the proof of concept. Build it well and let it speak.
...
*Prepared April 2026. Revisit and revise at each phase transition.*
